...
# OrdinaryDiffEq is only needed for its solver dispatch (the default algorithm
# selected by `solve`); all interface names used below come from SciMLBase.
import OrdinaryDiffEq
using SciMLBase: CallbackSet, EnsembleProblem, EnsembleSolution, EnsembleThreads,
    ODEProblem, SciMLBase, solve
...
"""
function daedalus(
        country::Union{String, DataLoader.CountryData}, infection::String;
    ...
    return daedalus(
        country, infection_data; npi = npi, log_rt = log_rt,
